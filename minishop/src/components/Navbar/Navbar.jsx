     ...
     {  
          <Nav>
            <Dropdown style={{ height:"50px",padding:"0px"}}  variant="Danger" alignRight>
              ...
              <FaShoppingCart style={{ marginTop:"11px"}} color="white" fontSize="28px"    />
                    ...
                    {cartData.map((prod) => (
                      <span className="cartitem" key={prod.id}>
                        ...
                        <MdRemoveShoppingCart
                         onClick={()=>{
                          dispatch(deleteCartItem(prod.id)).then(()=> dispatch(cartActions()));
                          // dispatch(cartActions());
                          }}
                        className="del"
                          fontSize="20px"
          ...
          {cartData?.length > 0 ? ( <Badge bg="danger" style={{height:"20px",marginRight:"40px",marginLeft:"-20px"}} >{cartData?.length}</Badge>) 
          :(console.log("badge"))}
              </ButtonGroup>
    </Box>
   </Flex>
