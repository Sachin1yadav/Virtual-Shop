...
const Products = () => {
    ...
    const getSimilarData =async () => {
        try {
            const res = await fetch(`https://lackadaisical-volcano-larch.glitch.me/data/?q=${sort}`);
    ...
    console.log("line22",Categories);
      ...
      return (
        <div>
            ...
            <button onClick={()=>setSort('shoes')} >{sort}</button>
            <div className="main_container" > 
                <div><LeftSideFilter/></div>
            <div className="proMainDiv">
       
              {
                    ...
                    <img
                      ...
                      alt="name"
                    />
                    <p className="proName">{el.brand.length < 8 ? el.brand : `${el.brand.slice(0, 8)}`}</p>
